...
test-is : show (evalTL₁ inner-simon test-vec4) ≡
  ...
  ((𝕋 , 𝕋 , 𝕋 , 𝔽) ,        4.738173134873553e-17) ∷
  ((𝕋 , 𝕋 , 𝔽 , 𝕋) ,        4.5106981034918784e-17) ∷
  ((𝕋 , 𝕋 , 𝔽 , 𝔽) , 0.5000000000000001) ∷
  ((𝕋 , 𝔽 , 𝕋 , 𝕋) ,        -2.24482377131352e-11) ∷
  ((𝕋 , 𝔽 , 𝕋 , 𝔽) ,        3.350394354180222e-17) ∷
  ((𝕋 , 𝔽 , 𝔽 , 𝕋) ,        1.8013739550477034e-17) ∷
  ((𝕋 , 𝔽 , 𝔽 , 𝔽) ,        2.244829322428643e-11) ∷
  ((𝔽 , 𝕋 , 𝕋 , 𝕋) ,        -2.2448209957559584e-11) ∷
  ((𝔽 , 𝕋 , 𝕋 , 𝔽) ,        5.7483679261733055e-18) ∷
  ((𝔽 , 𝕋 , 𝔽 , 𝕋) ,        5.1923354385602495e-18) ∷
  ((𝔽 , 𝕋 , 𝔽 , 𝔽) ,        2.24482377131352e-11) ∷
  ((𝔽 , 𝔽 , 𝕋 , 𝕋) , 0.5000000000000002) ∷
  ((𝔽 , 𝔽 , 𝕋 , 𝔽) ,        8.129419882522301e-18) ∷
  ((𝔽 , 𝔽 , 𝔽 , 𝕋) ,        -1.7351405419289864e-17) ∷
